...
import           Quilt                    (Color, QuiltFun, evalQuilt, reservedWords)
...
description :: String
description = "Welcome to The Quilterator! For help, type in ':help'"


instructions :: String
instructions = unlines ["Quilt is a simple language that comes with a number of features such as The following:"
  , " "
  , "     - A color is a list of numbers(integers or floats) or any of the built in color names."
  , "     - You can also get a color by typing in a number by itself. For example, 0 is black "
  , "     - Different functions are pre-rewritten for you!. You can also define variables of your own.",
    "     - Unfortunately However, you cannot define functions yet!But That is coming soon also"
  , "     - Quilt has a number of builtin keywords To see their list, you can type ':res_words'."
  , " ",
    "For more help, type ':help' "]

res_words :: String
res_words = unlines reservedWords
...
helpMsg = unlines
  ...
  , ":insts                   - print instructions for the language"
  , ":res_words               - print a list of reserved words in the language"
  , ":quit                    - quit."
      ...
      case minput of
        ...
        Just s       -> do
          ...
          shouldLoop <- case cmd of
            ...
            ":insts" -> (lift $ outputStrLn instructions) >> return True
            ":res_words" -> (lift $ outputStrLn res_words) >> return True
